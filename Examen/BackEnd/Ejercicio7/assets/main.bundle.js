...
var UsuarioComponent = (function () {
    ...
    UsuarioComponent.prototype.crearUsuario = function (formulario) {
        ...
        this._http.post(this._masterURL.url + 'Usuario', this.nuevoUsuario).subscribe(function (res) {
